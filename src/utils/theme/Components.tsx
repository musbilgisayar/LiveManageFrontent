...
// ===========================================================
// 🧱 FORM DENSITY (comfortable form height & spacing)
// ===========================================================
MuiFormControl: {
  styleOverrides: {
    root: {
...
MuiInputBase: {
  styleOverrides: {
    input: {
      "&::placeholder": {
        fontSize: "0.675rem",                // 🔹 Daha küçük font
        color: theme.palette.text.disabled,  // 🔹 Tema ile uyumlu soluk gri
        opacity: 1,                          // 🔹 Safari/Firefox uyumu
        fontWeight: 4400,                     // 🔹 İnce ama okunabilir
      },
    },
  },
},
