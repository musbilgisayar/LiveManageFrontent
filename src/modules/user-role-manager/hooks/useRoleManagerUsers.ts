...
type UseRoleManagerUsersReturn = {
  ...
  pagination:
    PagedResult<RoleManagerUserListItemDto> | null;

  filters: RoleManagerUserFilters;

  setFilters:
    React.Dispatch<
      React.SetStateAction<RoleManagerUserFilters>
    >;
...
export default function useRoleManagerUsers(
  ...
  const [filters, setFilters] =
    useState<RoleManagerUserFilters>(
      INITIAL_FILTERS,
    );
