export { default as LocalizationListPage } from "./pages/manager/LocalizationListPage";
export { default as LocalizationKeysPage } from "./pages/manager/LocalizationKeysPage";
