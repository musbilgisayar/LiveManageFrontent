...
import { BlogType, BlogPostType } from '@/app/[locale]/(DashboardLayout)/types/apps/blog';
...
export const BlogProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const { data: postsData, isLoading: isPostsLoading, error: postsError } = useSWR('/api/blog', getWebFetcher);
