...
export const InvoiceProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const { data: invoiceData, isLoading: isInvoiceLoading, error: invoiceError, mutate } = useSWR("/api/invoice", getWebFetcher);
    ...
    const addInvoice = async (newInvoice: InvoiceList) => {
        try {
            await mutate(postWebFetcher('/api/invoice', newInvoice));
        } catch (error) {
