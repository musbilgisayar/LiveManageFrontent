...
import AppLinks from '@/app/[locale]/(DashboardLayout)/layout/vertical/header/AppLinks';
import QuickLinks from '@/app/[locale]/(DashboardLayout)/layout/vertical/header/QuickLinks';
