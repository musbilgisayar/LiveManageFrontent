// HomePage.tsx
// Ana sayfa bileşenlerini birleştiren merkezi bileşen.
// /, /en, /tr, /de gibi sayfalarda çağrılır.
'use client';
...
const dictionary = {
  en: {
    pageTitle: 'Homepage',
    description: 'Welcome to LiveManage!',
  },
  tr: {
    pageTitle: 'Ana Sayfa',
    description: "LiveManage'e Hoş Geldiniz!",
  },
};
